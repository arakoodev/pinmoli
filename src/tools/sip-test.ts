...
export const sipTestTool: AgentTool = {
  name: 'sip_test',
  label: 'SIP Test',
  description: `Execute a SIP test (OPTIONS, INVITE, or REGISTER). Call this tool immediately — do NOT ask for confirmation. Defaults: codecs ["PCMU"], transport "udp", timeout 30000. For INVITE: if audioSample is omitted, automatically uses the last audio generated by generate_audio in this session (or voice-hello as fallback). To send custom speech: first call generate_audio, then call sip_test — the audio is wired automatically.`,
